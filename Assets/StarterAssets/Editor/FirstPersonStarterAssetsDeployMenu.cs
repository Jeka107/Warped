...
namespace StarterAssets
{
    public partial class StarterAssetsDeployMenu : ScriptableObject
    {
        ...
        {
            var firstPersonControllers = FindObjectsOfType<PlayerMovement>();
            ...
            if (player == null)
            {
                if (TryLocatePrefab(PlayerCapsulePrefabName, null, new []{typeof(PlayerMovement) }, out GameObject prefab, out string _))
                {
        ...
        {
            if (TryLocatePrefab(PlayerCapsulePrefabName, null, new[] { typeof(PlayerMovement), typeof(StarterAssetsInputs) }, out GameObject _, out string prefabPath))
            {
